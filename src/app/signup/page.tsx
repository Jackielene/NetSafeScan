...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // You might want to redirect to login or dashboard
    } catch (err) {
        ...
        <form onSubmit={handleSubmit}>
          <Card className="bg-white/10 backdrop-blur-sm border-white/20 shadow-2xl">
            <CardHeader className="text-center pb-8">
              ...
              <CardDescription className="text-gray-300 text-lg">Join NetSafeScan and browse safely</CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <Button 
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white h-12 text-lg font-medium"
